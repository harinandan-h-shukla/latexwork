...
import { signUp, type OAuthProvider } from "@/lib/mock-api/auth";
...
export default function SignUpPage() {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Couldn't create your account");
    } finally {
      setPending(null);
    }
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 p-4">
      <Card className="w-full max-w-sm">
        <CardHeader className="items-center gap-1 text-center">
          ...
          <CardDescription>Start writing LaTeX in the cloud, free.</CardDescription>
        </CardHeader>
