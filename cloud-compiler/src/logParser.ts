 ...
 * records. Ported from local-agent/src/logParser.ts unchanged — this parses
 * latexmk/TeX's own output format, which is identical whether latexmk runs
 * on a user's machine or in this service.
 */
